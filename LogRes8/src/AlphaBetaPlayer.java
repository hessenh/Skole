...
public class AlphaBetaPlayer extends Player {
	...
	int plydepth = 5; // Always looks two moves ahead
	...
	public void makeMove() {
		...
		ValuedMove m = createTree(gamestate, 0, gamestate.playerturn, alpha, beta);
	...
	public int evaluate(GameState state, int you) {
		...
		if (state.alive() <= 1) {
			if (youp.condition >= 0)
				return 2000; // You're alive and someone else died!
			if (youp.condition == -2)
				return -3000; // I WON'T run off!
